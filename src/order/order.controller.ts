...
//Get orders for pickup verification
export const getOrderForPickupVerificationController = async (req: Request, res: Response) => {
  try {
    ...
    const order = await getOrderForPickupVerificationService(orderId);
