...
//     let replacementOrderResult;
//     try {
//       replacementOrderResult = await db.insert(orders).values({
//         userId: order.userId,
//         status: "paid",
//         paymentStatus: "paid",
//         totalAmount: "0",
...
//       }).returning();
//     } catch (err: any) {
//       // console.error("Replacement order insert failed");
...
//         shopId: originalItem.shopId,
//         replacementForReturnId: returnRecord.id,
//         originStationId: sanitizeInt(order.originStationId),
//       })
//       .returning();
...
//   } catch (err: any) {
//     //Global fallback (in case failure happens elsewhere)
//     // console.error("exchangeResolution failed");
//     // console.error("message:", err?.message);
//     // console.error("cause:", err?.cause);
//     throw err;
//   }
